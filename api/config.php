...
defined('DB_PASS') || define('DB_PASS', '***REMOVED-DB-PASSWORD-SEE-SECURITY-INCIDENT***');

// API Keys
defined('ORS_API_KEY') || define('ORS_API_KEY', '***REMOVED-ORS-API-KEY-SEE-SECURITY-INCIDENT***');
