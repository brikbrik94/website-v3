...
- [x] **Step 3: Implement `renderLiveKpis` (New)**
...
- [x] **Step 4: Update `renderStatsPanel`**
...
- [x] **Step 5: Update `renderSourcesPanel` (Replaces `renderHealthPanel`)**
